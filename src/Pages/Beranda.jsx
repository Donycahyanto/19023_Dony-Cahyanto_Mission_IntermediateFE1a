...
const Beranda = () => {
  return (
    <div className="min-h-screen">
      <header className="max-w-360 mx-auto px-4 md:px-10 xl:px-30 py-6 md:py-10 mt-2">
      ...
      <main className="max-w-360 mx-auto px-4 md:px-10 xl:px-30 py-2 flex flex-col gap-8">
